...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 h-16 bg-[#0F172A]/95 backdrop-blur border-b border-[#1E293B] flex items-center justify-between px-6">
      {/* Left side - Search */}
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="입찰공고 검색..."
            className="w-80 h-10 pl-10 pr-4 rounded-lg bg-[#1E293B] border border-[#334155] text-white placeholder-[#64748B] text-sm focus:outline-none focus:border-[#3B82F6]"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        {/* Live status */}
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#1E293B] border border-[#22C55E]/30">
